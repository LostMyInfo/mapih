...
import type { _File } from '../api/utils/storage';
import type { AccessTokenResponse, AllowedMentions, Application, ApplicationCommand, ApplicationCommandOption, ApplicationCommandOptionChoice, ApplicationRoleConnection, ApplicationRoleConnectionMetadata, Attachment, AuditLog, AutoModAction, AutoModRule, AutoModTriggerMetadata, Channel, Component, Connection, DefaultReaction, Embed, Emoji, Entitlement, EventEntityMetadata, EventUser, ExtendedInvite, FollowedChannel, ForumTag, ForumThreadMessageParams, Guild, GuildApplicationCommandPermissions, GuildBan, GuildFeatures, GuildHomeSettings, GuildIntegration, GuildOnboarding, GuildPreview, GuildScheduledEvent, GuildTemplate, GuildVoiceRegion, GuildWelcomeScreen, GuildWelcomeScreenChannel, GuildWidget, GuildWidgetSettings, InteractionParams, LocalizationMap, Member, Message, MessageReference, OnboardingPrompt, Overwrite, PartialEntitlement, PartialGuild, PermissionNames, Role, SKU, StageInstance, Sticker, StickerPack, ThreadMember, User, Webhook } from './api/discord/types/types';
// import { create1, create2, create3 } from './api/openai';
import type { ChatCompletion, ChatCompletionMessage, OpenAIEmbeddingResponse, OpenAIImageResponse } from './api/openai/types/types';
import type { SlackBlock } from './api/slack/types/Blocks';
import type { ModalView, SlackAttachment, SlackChannel, SlackMessageResponse, SlackUser, SlackUserIdentity, SlackUserProfile } from './api/slack/types/types';
import type { SpotifyReturn } from './api/spotify/resources/types';
import type { TwitterExpansions, TwitterMediaFields, TwitterPlaceFields, TwitterPollFields, TwitterSingleUserLookupResponse, TwitterTweetFields, TwitterTweetLookupResponse, TwitterTweetLookupResponseSingle, TwitterUserFields } from './api/twitter/resources/types';
import type { AnthropicMessageParam, AnthropicMessage, AnthropicTools } from './api/anthropic/types/types';

export interface twitter_token {
  api_key?: string;
  api_secret?: string;
  client_id: string;
...
export interface spotify_token {
  client_id: string;
  client_secret: string;
  redirect_uri: string;
  scope?: string;
...
export interface dropbox_token {
  basic_token?: string;
  access_token?: string;
  client_id: string;
  client_secret: string;
...
export interface box_token {
  client_id: string;
  client_secret: string;
  redirect_uri: string;
}

export interface imgur_token {
  client_id: string;
  client_secret?: string;
  access_token?: string;
}
...
declare module 'mapih' {
  ...
  export function get_token(service: keyof Tokens | string): Tokens[keyof Tokens];
  ...
  export const discord: {
    ...
    automod: {
      ...
      getAllRules(params: { guild_id: string; }): Promise<AutoModRule[]>;
      createRule(params: {
        guild_id: string;
        name: string;
        event_type: number;
    ...
    invites: {
      ...
      revoke(params: { invite_code: string; }): Promise<ExtendedInvite>;
    };
    applications: {
    ...
    channels: {
      ...
      destroy(params: { channel_id: string; }): Promise<Channel>;
      updatePermissions(params: {
        channel_id: string;
        overwrite_id: string;
        type: 0 | 1;
    ...
    guilds: {
      ...
      emojis: {
        ...
        getAll(params: { guild_id: string; }): Promise<Emoji[]>;
        create(params: {
          guild_id: string;
          name: string;
          image: string | Buffer;
      ...
      stickers: {
        retrieve(params: { sticker_id: string; }): Promise<Sticker>;
        nitroPacks(): Promise<StickerPack[]>;
        getAll(params: { guild_id: string; }): Promise<Sticker[]>;
      ...
      templates: {
        retrieve(params: { template_code: string; }): Promise<GuildTemplate>;
        getAll(params: { guild_id: string; }): Promise<GuildTemplate[]>;
        create(params: {
          guild_id: string;
          name: string;
          description?: string | undefined;
    ...
    webhooks: {
      retrieve(params: { webhook_id: string; }): Promise<Webhook>;
      retrieveWithToken(params: {
        webhook_id: string;
        webhook_token: string;
      }): Promise<Omit<Webhook, "user">>;
      retrieveChannel(params: { channel_id: string; }): Promise<Webhook[]>;
      retrieveGuild(params: { guild_id: string; }): Promise<Webhook[]>;
      ...
      destroy(params: { webhook_id: string; }): Promise<{ statusCode: number; message: string; }>;
    ...
    stageInstance: {
      retrieve(params: { channel_id: string; }): Promise<StageInstance>;
      create(params: {
        channel_id: string;
        topic: string;
        privacy_level?: number | undefined;
      ...
      destroy(params: { channel_id: string; }): Promise<{ statusCode: number; message: string; }>;
    };
    interactions: {
      callback: {
        ...
        component_defer(params: Pick<InteractionParams, "id" | "token">, input?: {
          ephemeral?: boolean | undefined;
        } | undefined): Promise<{ statusCode: 204; body: undefined; }>;
        ...
        delete_original(params: Pick<InteractionParams, "token" | "application_id">): Promise<{ statusCode: 204; body: undefined; }>;
        upgrade(params: Pick<InteractionParams, "id" | "token">, input?: object | undefined): Promise<{ statusCode: 204; body: undefined; }>;
      };
      followup: {
        ...
        destroy(params: Pick<InteractionParams, "token" | "application_id">, input: { message_id: string; }): Promise<{ statusCode: 204; body: undefined; }>;
      };
    };
    oauth2: {
      token: {
      ...
      credentials: {
        user(params: { token: AccessTokenResponse; }): Promise<User | null>;
        client(params: {
          client_id: string;
          client_secret: string;
          scope: string;
    ...
    users: {
      retrieve(params: { user_id: string; }): Promise<User>;
      ...
      currentMember(params: { guild_id: string; }): Promise<Member>;
      updateCurrent(params: {
        username?: string | undefined;
        avatar?: string | Buffer | null | undefined;
      }): Promise<User>;
      connections(): Promise<Connection[]>;
      appRoleConnection(params: { application_id: string; }): Promise<ApplicationRoleConnection>;
      ...
      leaveGuild(params: { guild_id: string; }): Promise<{ statusCode: number; message: string; }>;
    };
  };
  ...
  export const utils: {
    ...
    storage: {
      ...
      local: {
        /**
         * @example
         * await api.utils.storage.local.get('keyname');
         *
         * @example
         * await api.utils.storage.local.get('keyname', { default: [] });
         *
         * @param key
         * @param options
        ...
        /**
         * @example
         * api.utils.storage.local.getSync('keyname');
         *
         * @example
         * api.utils.storage.local.getSync('keyname', { default: [] });
         *
         * @param key
         * @param options
         * @param options.default - The default value to return if the key does not exist.
      ...
      getMany(keys: string[]): Promise<{[x: string]: any}>;
         ...
         *
         * @example
         * api.utils.storage.local.setSync({
         *   key: 'DontChangeMe',
         *   value: 'abcd1234',
         *   allow_overwrite: false
         * });
        ...
        /**
         * @example
         * await api.utils.storage.local.setMany({
         *   keyname1: 'value1',
         *   keyname2: 'value2',
         *   keyname3: 'value3'
         * });
        ...
        /**
         * @example
         * await api.utils.storage.local.delete('password'); //=> true
         *
         * await api.utils.storage.local.delete('password', {
         *   keep_history: true
         * });
         *
         * @param key
        ...
        /**
         * @example
         * api.utils.storage.local.deleteSync('password'); //=> true
         *
         * api.utils.storage.local.deleteSync('password', {
         *   keep_history: true
         * });
         *
         * @param key
        ...
        /**
         * @example
         * await api.utils.storage.local.deleteMany(['key1', 'key2']);
         * //=> [true, true]
         *
         * @param keys
        ...
        /**
         * @example
         * await api.utils.storage.local.set({
         *   key: 'password',
         *   value: [1, 2, 3, 4, 5]
         * });
         *
         * await api.utils.storage.local.filterValues('password', (x): x !== 2);
         *
         * await api.utils.storage.local.get('password');
         * //=> '[ 1, 3, 4, 5 ]'
         *
         * @param key
         * @param  predicate
  ...
  export interface MySQLOriginalError {
    message: string;
    code: string;
    errno: string;
    sql: string;
  ...
  export class MySQLStorageError extends Error {
     ...
     */
    constructor(message: string, operation: string, originalError: MySQLOriginalError | Error);

    name: 'MySQLStorageError';
    operation: string;
    originalError: MySQLOriginalError | Error;
  }
  ...
  export const slack: {
    users: {
      ...
      lookup({ email }: { email: string; }): Promise<{
        ok: boolean;
        user: SlackUser;
      }>;
    };
